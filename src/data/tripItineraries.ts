...
const tripItineraries: Record<string, TripItineraryData> = {
  ...
  "manali-shimla-kasol-amritsar-015": {
    ...
    itinerary: [
      { day: 1, title: "13 May — Chandigarh → Shimla (~120 km | 3.5–4 hrs)", icon: Route, stay: "Shimla (Night 1 of 2)", items: ["Depart early morning from Chandigarh", "Reach Shimla by noon and check in", "Evening: Explore The Ridge, Mall Road, and Christ Church", "Soak in the cool mountain air and colonial charm"] },
      { day: 2, title: "14 May — Shimla Local + Kufri (~32 km round trip)", icon: Mountain, stay: "Shimla (Night 2 of 2)", items: ["Morning drive to Kufri — panoramic views, horse rides & activities", "Return by afternoon for lunch", "Evening: Jakhu Temple for sunset views", "Explore Scandal Point & Lakkar Bazaar for souvenirs"] },
      { day: 3, title: "15 May — Shimla → Kasol → Manikaran → Manali (~290 km | 9–10 hrs)", icon: Route, stay: "Manali (Night 1 of 4)", items: ["Early start (~6:30 AM) — scenic drive via Mandi", "Reach Kasol by noon — riverside cafés and relaxed bohemian vibe", "Visit Manikaran Sahib — sacred hot springs and community langar", "Continue to Manali — arrive by evening and check in"] },
      { day: 4, title: "16 May — Manali Local Sightseeing (~30 km)", icon: Sun, stay: "Manali (Night 2 of 4)", items: ["Hadimba Temple nestled in cedar forests", "Manu Temple & Club House visit", "Vashisht Hot Springs — natural thermal baths", "Mall Road walk — local food, shopping & evening stroll"] },
      { day: 5, title: "17 May — Solang Valley + Atal Tunnel + Rohtang (~120 km)", icon: Mountain, stay: "Manali (Night 3 of 4)", items: ["Start early for Solang Valley — adventure & snow activities", "Drive through the iconic Atal Tunnel to Sissu (Lahaul Valley)", "Visit Rohtang Pass — breathtaking snow landscapes (permit required)", "Return to Manali by evening for rest"] },
      { day: 6, title: "18 May — Manali Leisure + Naggar (~30 km)", icon: Camera, stay: "Manali (Night 4 of 4)", items: ["Visit Naggar Castle — 500-year-old Himalayan heritage", "Explore Roerich Art Gallery — Russian artist's mountain retreat", "Evening: Old Manali cafés, souvenir shopping", "Relaxed buffer day to recharge"] },
      { day: 7, title: "19 May — Manali → Amritsar (~310 km | 8 hrs)", icon: Landmark, stay: "Amritsar (Night 1 of 1)", items: ["Early departure from Manali", "Comfortable drive — reach Amritsar by afternoon", "Evening: Golden Temple visit & Palki Sahib ceremony", "Experience the spiritual atmosphere at night"] },
      { day: 8, title: "20 May — Amritsar Sightseeing & Departure", icon: Sun, stay: null, items: ["Early Golden Temple visit during Amrit Vela (pre-dawn)", "Jallianwala Bagh — pay respects at the historic memorial", "Partition Museum — powerful storytelling of 1947", "Wagah Border ceremony — patriotic flag-lowering experience", "Trip ends 🏁"] },
    ],
    staySummary: [
