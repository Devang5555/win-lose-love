...
import { ArrowRight, Waves, Mountain, Utensils } from "lucide-react";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-32 text-center">
        ...
        <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold text-background mb-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <span className="block text-primary mt-2">Konkan Adventures</span>
        </h1>

        <p className="text-lg md:text-xl text-background/90 max-w-2xl mx-auto mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          Pristine beaches, ancient forts, thrilling water sports, and authentic Malvani cuisine — 
          experience it all with our curated group trips.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.4s' }}>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-sm border border-background/20">
            ...
            <span className="text-sm text-background font-medium">Water Sports</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-sm border border-background/20">
            <Mountain className="w-5 h-5 text-primary" />
            <span className="text-sm text-background font-medium">Historic Forts</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-sm border border-background/20">
            <Utensils className="w-5 h-5 text-primary" />
            <span className="text-sm text-background font-medium">Malvani Cuisine</span>
          </div>
        </div>
      </div>
